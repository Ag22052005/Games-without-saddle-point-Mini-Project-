public class Backend {
    ...
    static String resultsP1[];
    static String resultsP2[];
    ...
    public static void displayNashEqmO2() {
        ...
        if (m1 == 4) {
            ...
            System.out.println(disply1[0] + " " + disply2[0]);
            return;
        }
        res = 0;
        count0 = 0;
    ...
    public static void displayNashEqmO3() {
        // String disply1[] = new String[3];
        // String disply2[] = new String[3];
        // System.out.println(
        // "THE PROBABILITIES FOR PLAYER 1 TO CHOOSE STRATEGY 1. STRATEGY 2 AND STRATEGY
        // 3 RESPECTIVELY ARE: ");
        for (int i = 0; i < m - 1; i++) {
            // System.out.println(p1oddments[i] / hcfforpl1[i] + "/" + oddmenttotal1 /
            // hcfforpl1[i]);
            disply1[i] = p1oddments[i] / hcfforpl1[i] + "/" + oddmenttotal1 / hcfforpl1[i];

        }
        // System.out.println(
        // "THE PROBABILITIES FOR PLAYER 2 TO CHOOSE STRATEGY 1. STRATEGY 2 AND STRATEGY
        // 3 RESPECTIVELY ARE: ");
        for (int i = 0; i < m - 1; i++) {
            // System.out.println(p2oddments[i] / hcfforpl2[i] + "/" + oddmenttotal2 /
            // hcfforpl2[i]);
            disply2[i] = p2oddments[i] / hcfforpl2[i] + "/" + oddmenttotal2 / hcfforpl2[i];
        }

        // new outputlayout(disply1,disply2);
    }
}